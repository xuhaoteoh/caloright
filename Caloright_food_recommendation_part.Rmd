...
## nutrients with maximum micronutrients
max_nutrients = my_nurients_data

max_carbs = max(max_nutrients$Carbs)
highest_carbs= max_nutrients %>% filter(Carbs == max_carbs) %>% select(Food,Carbs,Protein,Fat,Grams)
highest_carbs # food with max carbs

max_protein = max(max_nutrients$Protein)
highest_protein= max_nutrients %>% filter(Protein == max_protein) %>% select(Food,Carbs,Protein,Fat,Grams)
highest_protein # food with max protein

max_fat = max(max_nutrients$Fat)
highest_fat= max_nutrients %>% filter(Fat == max_fat) %>% select(Food,Carbs,Protein,Fat,Grams)
